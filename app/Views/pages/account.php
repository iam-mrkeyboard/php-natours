...
<main class="main" style="background-color: #f7f7f7; padding: 8rem 0; min-height: 80vh;">
    <div class="user-view" style="background-color: #fff; max-width: 120rem; margin: 0 auto; min-height: 75vh; border-radius: 3px; overflow: hidden; box-shadow: 0 2.5rem 8rem 2rem rgba(0, 0, 0, 0.07); display: flex;">
        ...
        <div class="user-view__content" style="flex: 1; padding: 7rem 8rem;">
            <div class="user-view__form-container">
                ...
                <form class="form form-user-data">
                    <div class="form__group" style="margin-bottom: 2rem;">
                        ...
                        <input class="form__input" id="name" type="text" value="<?= $user['name'] ?>" required style="display: block; font-family: inherit; color: inherit; font-size: 1.5rem; padding: 1.25rem 1.75rem; border: none; border-bottom: 3px solid transparent; width: 100%; transition: all 0.3s; background-color: #f2f2f2; border-radius: 4px;">
                    </div>
                    <div class="form__group" style="margin-bottom: 3rem;">
                        ...
                        <input class="form__input" id="email" type="email" value="<?= $user['email'] ?>" required style="display: block; font-family: inherit; color: inherit; font-size: 1.5rem; padding: 1.25rem 1.75rem; border: none; border-bottom: 3px solid transparent; width: 100%; transition: all 0.3s; background-color: #f2f2f2; border-radius: 4px;">
                    </div>
                    <div class="form__group right" style="text-align: right;">
                        <button class="btn btn--small btn--green" style="font-size: 1.4rem; padding: 1.25rem 3rem; background-color: #55c57a; color: #fff; border-radius: 10rem; border: none; text-transform: uppercase; cursor: pointer;">Save settings</button>
                    </div>
                </form>
            </div>
            ...
            <div class="user-view__form-container">
                <h2 class="heading-secondary u-margin-bottom-medium" style="font-size: 2.25rem; text-transform: uppercase; font-weight: 700; background-image: linear-gradient(to right, #7ed56f, #28b485); -webkit-background-clip: text; color: transparent; letter-spacing: 0.1rem; border-bottom: 3px solid transparent; display: inline-block; margin-bottom: 3rem;">Password change</h2>
                ...
                <form class="form form-user-password">
                    ...
                    <div class="form__group right" style="text-align: right;">
                        <button class="btn btn--small btn--green" style="font-size: 1.4rem; padding: 1.25rem 3rem; background-color: #55c57a; color: #fff; border-radius: 10rem; border: none; text-transform: uppercase; cursor: pointer;">Save password</button>
                    </div>
                </form>
            </div>
        </div>
